...
import BisnisForms from '@/Pages/Profile/Partials/BisnisForms.vue';
...
const getTitle = computed(() => {
    switch (props.tab) {
        ...
        case 'bisnis': return 'Profil Bisnis';
        case 'keamanan': return 'Keamanan';
        case 'transaksi': return 'Pesanan Saya';
        case 'terakhir-dilihat': return 'Terakhir Dilihat';
        case 'pencarian': return 'Riwayat Pencarian';
        case 'ulasan': return 'Ulasan Saya';
        case 'favorit': return 'Aset Favorit';
        default: return 'Profil Saya';
    }
});
    ...
    <ProfileLayout isDashboard :title="getTitle">
        ...
        <div class="bg-white p-6 shadow-md rounded-2xl">
            <div class="flex items-center justify-between mb-6">
                ...
                <!-- Desktop Link -->
                <Link
                    :href="route('owner.profile', { tab: 'transaksi' })"
