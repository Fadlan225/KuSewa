        ...
        <form @submit.prevent="updatePassword" class="space-y-6">
            <div>
                ...
                <input
                    ...
                    type="password"
                    class="block w-full border-gray-300 focus:border-[#FFC000] focus:ring-[#FFC000] rounded-md shadow-sm px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#FFC000]"
            ...
            <div class="flex items-center gap-4 pt-4">
                <button
                    ...
                    class="inline-flex items-center px-6 py-3 bg-primary border border-transparent rounded-md font-bold text-xs text-white uppercase tracking-widest hover:bg-[#0f3459] active:scale-95 focus:outline-none focus:ring-2 focus:ring-[#FFC000] focus:ring-offset-2 transition ease-in-out duration-150 disabled:opacity-25"
                >
                    Simpan Kata Sandi
                </button>
