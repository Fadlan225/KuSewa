            ...
            <div v-else-if="step === 'otp'" class="animate-fade-in text-center pt-4">
                ...
                <div class="flex justify-center mb-6">
                    <TextInput
                        ...
                        type="text"
                        maxlength="6"
                        class="text-center text-3xl font-extrabold tracking-[0.5em] w-48 bg-[#F8F9FA] p-2 border-[#6C757D]/30 focus:border-[#FFC000] focus:ring-[#FFC000] focus:outline-none focus:ring-2 focus:ring-[#FFC000]"
                        placeholder="••••••"
