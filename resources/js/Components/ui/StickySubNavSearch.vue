...
import { Search, Sliders, ChevronDown, Locate, Check, ChevronLeft, ChevronRight } from 'lucide-vue-next';
    ...
    <div class="w-full bg-white border-b border-[#6C757D]/10 py-3 relative z-[70]">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex lg:hidden items-center bg-white rounded-full border border-gray-200 shadow-sm p-1">
                <div class="flex-1 flex items-center pl-3 pr-2 relative overflow-hidden" @click="isKeywordSheetOpen = true" style="min-height: 36px;">
                    <Search class="text-[#0A2540] mr-3 relative z-10" />
                    <AnimatedPlaceholder
        ...
        <div class="flex flex-row items-center justify-between w-full transition-all duration-300 relative z-50 gap-3">
            ...
            <div @click="desktopActiveMenu = desktopActiveMenu === 'jenis' ? null : 'jenis'" class="flex-1 flex items-center justify-between px-4 py-2 bg-white border cursor-pointer group hover:border-[#FFC000] hover:shadow-md rounded-lg transition-all duration-200" :class="desktopActiveMenu === 'jenis' ? 'border-[#FFC000] shadow-md ring-1 ring-[#FFC000]' : 'border-gray-300'">
                ...
                <ChevronDown class="text-[#6C757D]/70 text-[10px] group-hover:text-[#0A2540] transition-colors" :class="desktopActiveMenu === 'jenis' ? 'rotate-180 text-[#0A2540]' : ''" />
            </div>

            <!-- Item 2: Lokasi -->
            <div @click="desktopActiveMenu = desktopActiveMenu === 'lokasi' ? null : 'lokasi'" class="flex-1 flex items-center justify-between px-4 py-2 bg-white border cursor-pointer group hover:border-[#FFC000] hover:shadow-md rounded-lg transition-all duration-200" :class="desktopActiveMenu === 'lokasi' ? 'border-[#FFC000] shadow-md ring-1 ring-[#FFC000]' : 'border-gray-300'">
                <div class="flex flex-col">
                ...
                <ChevronDown class="text-[#6C757D]/70 text-[10px] group-hover:text-[#0A2540] transition-colors" :class="desktopActiveMenu === 'lokasi' ? 'rotate-180 text-[#0A2540]' : ''" />
            </div>

            <!-- Item 3: Jadwal -->
            <div @click="desktopActiveMenu = desktopActiveMenu === 'jadwal' ? null : 'jadwal'" class="flex-1 flex items-center justify-between px-4 py-2 bg-white border cursor-pointer group hover:border-[#FFC000] hover:shadow-md rounded-lg transition-all duration-200" :class="desktopActiveMenu === 'jadwal' ? 'border-[#FFC000] shadow-md ring-1 ring-[#FFC000]' : 'border-gray-300'">
                <div class="flex flex-col">
                ...
                <ChevronDown class="text-[#6C757D]/70 text-[10px] group-hover:text-[#0A2540] transition-colors" :class="desktopActiveMenu === 'jadwal' ? 'rotate-180 text-[#0A2540]' : ''" />
            </div>

            <!-- Item 4: Rentang Harga -->
            <div @click="desktopActiveMenu = desktopActiveMenu === 'harga' ? null : 'harga'" class="flex-1 flex items-center justify-between px-4 py-2 bg-white border cursor-pointer group hover:border-[#FFC000] hover:shadow-md rounded-lg transition-all duration-200" :class="desktopActiveMenu === 'harga' ? 'border-[#FFC000] shadow-md ring-1 ring-[#FFC000]' : 'border-gray-300'">
                <div class="flex flex-col">
                ...
                <ChevronDown class="text-[#6C757D]/70 text-[10px] group-hover:text-[#0A2540] transition-colors" :class="desktopActiveMenu === 'harga' ? 'rotate-180 text-[#0A2540]' : ''" />
            </div>
        ...
        >
            <div v-if="desktopActiveMenu"
                 class="absolute top-[108%] bg-white rounded-[24px] shadow-xl border border-gray-200 p-6 z-40 flex flex-col max-h-[75vh] overflow-y-auto hide-scrollbar overscroll-contain transition-all"
                 :class="{
                    ...
                    <div v-if="['day', 'night'].includes(activeScheduleMode)" class="flex gap-8 px-2">
                        ...
                        <div class="flex-1">
                            <div class="grid grid-cols-7 gap-y-5 mb-1">
                                ...
                                <div v-for="date in monthsData[desktopCalendarPage]?.daysInMonth" :key="'d1-'+date" class="relative flex justify-center items-center h-10">
                                    <!-- KONEKTOR RENTANG -->
                                    <template v-if="date">
                        ...
                        <div class="flex-1">
                            <div class="grid grid-cols-7 gap-y-5 mb-1">
                                ...
                                <div v-for="date in monthsData[desktopCalendarPage + 1]?.daysInMonth" :key="'d2-'+date" class="relative flex justify-center items-center h-10">
                                    <!-- KONEKTOR RENTANG -->
                                    <template v-if="date">
