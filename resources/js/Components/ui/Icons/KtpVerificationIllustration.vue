<template>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 768.194 800" role="img" artist="Katerina Limpitsouni" source="https://undraw.co/" :class="props.class">
        <defs>
            <clipPath id="a-296">
        ...
        <g transform="translate(-549.879 -248.286)">
            ...
            <g transform="translate(932.045 705.569) rotate(-159)">
                ...
                <path d="M25.984,77.646,9.626,80.186a1.355,1.355,0,0,0-1.139,1.192h0A1.535,1.535,0,0,1,7.2,82.728l-3.445.536A3.251,3.251,0,0,1,0,79.972L1.773,6.483A3.712,3.712,0,0,1,5.156,2.875L37.363.011A2.867,2.867,0,0,1,37.363.011L37.363.011A2.867,2.867,0,0,1,40.479,3.04L36.132,74.55a4.626,4.626,0,0,1-3.907,4.286L28.6,79.4A2.308,2.308,0,0,0,25.984,77.646Z" transform="translate(3.337 3.84)" fill="#FFC000"/>
            </g>
            <g transform="translate(963.942 248.286)">
                    ...
                    <g transform="translate(0 0)">
                        ...
                        <g transform="translate(0 1.225)" clip-path="url(#a-296)">
                            <g transform="translate(20.748 25.67)">
                                ...
                                <path d="M224.626,345.538s-9.149-7.25-6.782-17.378c0,0-9.178.4-12.914,4.135s1.019,16.3,1.019,16.3,8.15,13.583,6.792,19.7-4.754,13.778,0,15.815,17.905,14.736,32.507,2.85c0,0,8.241-14.59-6.7-25.457v-8.489s2.717-2.377,1.358-8.489c0,0,5.773-10.527,2.377-12.564a101.049,101.049,0,0,0-11.2-5.023S231.757,342.143,224.626,345.538Z" transform="translate(-186.186 -297.939)" fill="#FFC000"/>
                                <path d="M178.381,340.831s-4.414-.679-8.829,5.774-15.96,16.639-10.527,21.733,20.035,8.489,20.035,8.489l3.4-6.114-14.6-7.131,12.223-9.168Z" transform="translate(-157.6 -306.476)" fill="#FFC000"/>
                                <path d="M294.056,340.864s4.754,0,6.792,5.774,13.923,25.469,13.923,25.469l2.128,6.959-4.654,2.922-8.68-8.862L291,352.41Z" transform="translate(-239.656 -306.509)" fill="#FFC000"/>
                ...
                <path d="M6.74,0H82.712a6.74,6.74,0,0,1,0,13.479H6.74A6.74,6.74,0,0,1,6.74,0Z" transform="translate(202.185 87.876)" fill="#FFC000"/>
                ...
                <path d="M6.74,0H219.953a6.74,6.74,0,1,1,0,13.479H6.74A6.74,6.74,0,0,1,6.74,0Z" transform="translate(64.944 179.779)" fill="#FFC000"/>
                <path d="M6.74,0H219.953a6.74,6.74,0,1,1,0,13.479H6.74A6.74,6.74,0,0,1,6.74,0Z" transform="translate(64.944 203.061)" fill="#FFC000"/>
